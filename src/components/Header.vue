...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark" role="navigation">
  <div class="container">
    ...
    <router-link to="/" class="navbar-brand mr-auto">Mi tienda Virtual</router-link>
    <button
